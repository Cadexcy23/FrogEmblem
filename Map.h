...
public:
	...
	enum mapStates {
		...
		MENU_CHARACTER,
		MENU_MAP,
		MENU_UNITS, //list of units in the battle you can look thru for detailed info
		MENU_PREPARE //before battle starts, select units, move items, save, etc
	};
